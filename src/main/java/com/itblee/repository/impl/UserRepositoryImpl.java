...
public class UserRepositoryImpl implements UserRepository {
    ...
    @Override
    public List<User> findByCondition(Map<?, ?> conditions) {
        return findByCondition(conditions, -1, -1);
    }

    @Override
    public List<User> findByCondition(Map<?, ?> conditions, int limit, int offset) {
        ...
        try {
            ...
            return executor.executeQuery(sql, User.class);
